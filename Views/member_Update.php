...
require_once (CONTROLLERPATH.'Controller_Members.php');
 	...
 	<tr>
				...
				<td align="left">
					<table>
						<tr>
							...
							<td align="left">
								<input class="input1" id="First_name" name="First_name"  value="<?php echo $Mdata['First_Name'];?>" type="text"  required="required">
							...
							<td align="left">
								<input class="input1" id="Business_phone" name="Business_phone"  value="<?php echo $Mdata['Business_Phone'];?>" type="text">
						...
						<tr>
							...
							<td align="left">
								<input class="input1" id="Last_name" name="Last_name"  value="<?php echo $Mdata['Last_Name'];?>" type="text"  required="required">
							...
							<td align="left">
								<input class="input1" id="Home_phone" name="Home_phone"  value="<?php echo $Mdata['Home_phone'];?>" type="text">
						...
						<tr>
							...
							<td align="left">
								<input class="input1" id="Mobile_phone" name="Mobile_phone"  value="<?php echo $Mdata['Mobile_phone'];?>" type="text">
						...
						<tr>
							...
							<td align="left">
								<input class="input1" id="Ssn" name="Ssn"  value="<?php echo $Mdata['SSN'];?>" type="text"  required="required">
						...
						<tr>
							...
							<td align="left">
								<input class="input1" id="Hire_date" name="Hire_date"  value="<?php echo $Mdata['Hire_Date'];?>" type="date">
							...
							<td align="left">
								<input class="input1" id="Termination_date" name="Termination_date"  value="<?php echo $Mdata['Termination_Date'];?>" type="date">
						...
						<tr>
							...
							<td align="left">
								<input class="input1" id="Email_id" name="Email_id"  value="<?php echo $Mdata['Email_id'];?>" type="text">
						...
						<tr>
							...
							<td align="left">
								<textarea class="input1" id="Address" name="Address" required="required" cols=2 rows=2><?php echo $Mdata['Address'];?></textarea>
							...
							<td rowspan="5" valign="top">
								<textarea name="note" id="note" rows="10" cols="15" class="input1"><?php echo $Mdata['Note']?></textarea>
						...
						<tr>
							...
							<td align="left">
								<input class="input1" id="City" name="City"  value="<?php echo $Mdata['City'];?>" type="text"  required="required">
						...
						<tr>
							...
							<td align="left">
								<input class="input1" id="State" name="State"  value="<?php echo $Mdata['State'];?>" type="text"  required="required">
						...
						<tr>
							...
							<td align="left">
								<input class="input1" id="Zip" name="Zip"  value="<?php echo $Mdata['Zip'];?>" type="text"  required="required">
    	...
    	<tr>
    		<td  align="center">
        		<table>
        			<tr>
        				<td align="center"><input type="submit" name="MemberUpdate" value="Update & Close"  class="small small-primary small-block small-large"></td>
        				<td  align="left"><input type="submit" name="MemberDelete" value="Delete"  class="small small-primary small-block small-large"></td>
        			</tr>			
        		</table>
        	</td>
